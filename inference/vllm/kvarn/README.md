...
only. This port originated in the single-RTX-3090 upstream stack and is
qualified here on an RTX 4090; see the root README for retained measurements.
...
The upstream RTX 3090 measurements found that 262k context fits
