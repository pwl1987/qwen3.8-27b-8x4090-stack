#!/bin/bash
# Qwen3.8-27B on a single RTX 4090 — SINGLE USER / LOW LATENCY mode.
# This launcher is derived from the single-RTX-3090 upstream stack; the public
# RTX 4090 profiles and retained measurements are documented in ../README.md.
#
